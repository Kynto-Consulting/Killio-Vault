...
/**
 * Deep-link target for workspace invitation links of the form
 *   killiovault://teams/accept?token=...
 *   https://killio.dev/teams/accept?token=...
 *
 * Accepts the invite via `POST /teams/invites/accept`, switches the active
 * workspace to the freshly joined one, and routes the user to /workspace.
 */
